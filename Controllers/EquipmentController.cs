...
namespace ozzy_mvc.Controllers
{
    public class EquipmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EquipmentID,Name,RemainAmount,LabNo")] Equipment equipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("EquipmentID,Name,RemainAmount,LabNo")] Equipment equipment)
        {
